...
const routes: Routes = [
  {
    ...
    children: [
      { path: '', redirectTo: 'dashboard', data: { roleIds: [AppConstant.ROUTE_ROLE_ID.ADMIN_ROLE, AppConstant.ROUTE_ROLE_ID.USER_ROLE,AppConstant.ROUTE_ROLE_ID.TEE_ROLE] }, pathMatch: 'full' },
      { path: 'dashboard', canActivate: [AuthGuardService], data: { roleIds: [AppConstant.ROUTE_ROLE_ID.ADMIN_ROLE, AppConstant.ROUTE_ROLE_ID.USER_ROLE,AppConstant.ROUTE_ROLE_ID.TEE_ROLE] }, loadChildren: () => import('./dashboard/dashboard.module').then(m => m.DashboardModule) },
     ...
     // { path: 'dg-maintenance-alert', canActivate: [AuthGuardService], data: { roleIds: [AppConstant.ROUTE_ROLE_ID.ADMIN_ROLE,AppConstant.ROUTE_ROLE_ID.TEE_ROLE, AppConstant.ROUTE_ROLE_ID.USER_ROLE] }, loadChildren: () => import('./dg-maintenance-alert/dg-maintenance-alert.module').then(m => m.DgMaintenanceAlertComponent) },
      ...
      { path: 'rca-report', canActivate: [AuthGuardService], data: { roleIds: [AppConstant.ROUTE_ROLE_ID.ADMIN_ROLE, AppConstant.ROUTE_ROLE_ID.USER_ROLE,AppConstant.ROUTE_ROLE_ID.TEE_ROLE] }, loadChildren: () => import('./rca-report/rca-report.module').then(m => m.RcaReportModule) },
      { path: 'rca-master', canActivate: [AuthGuardService], data: { roleIds: [AppConstant.ROUTE_ROLE_ID.ADMIN_ROLE,AppConstant.ROUTE_ROLE_ID.TEE_ROLE] }, loadChildren: () => import('./rca-master/rca-master.module').then(m => m.RcaMasterModule) },
      { path: 'reports', canActivate: [AuthGuardService], data: { roleIds: [AppConstant.ROUTE_ROLE_ID.ADMIN_ROLE, AppConstant.ROUTE_ROLE_ID.USER_ROLE,AppConstant.ROUTE_ROLE_ID.TEE_ROLE] }, loadChildren: () => import('./reports/reports.module').then(m => m.ReportsModule) },
      ...
      { path: 'google-data-studio', canActivate: [AuthGuardService], data: { roleIds: [AppConstant.ROUTE_ROLE_ID.ADMIN_ROLE, AppConstant.ROUTE_ROLE_ID.USER_ROLE,AppConstant.ROUTE_ROLE_ID.TEE_ROLE] }, loadChildren: () => import('./google-data-studio/google-data-studio.module').then(m => m.GoogleDataStudioModule) },
      { path: 'master-data', canActivate: [AuthGuardService], data: { roleIds: [AppConstant.ROUTE_ROLE_ID.ADMIN_ROLE,AppConstant.ROUTE_ROLE_ID.TEE_ROLE] }, loadChildren: () => import('./master-data/master-data.module').then(m => m.MasterDataModule) },
      { path: 'remote-commands', canActivate: [AuthGuardService], data: { roleIds: [AppConstant.ROUTE_ROLE_ID.ADMIN_ROLE,AppConstant.ROUTE_ROLE_ID.TEE_ROLE] }, loadChildren: () => import('./remote-commands/remote-commands.module').then(m => m.RemoteCommandsModule) },
