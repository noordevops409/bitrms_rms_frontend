...
@Component({
  selector: 'app-settable-load',
  templateUrl: './settable-load.component.html',
  styleUrls: ['./settable-load.component.scss']
})
export class SettableLoadComponent {
  ...
  private getAlertsTableDataByType() {
      ...
      this.apiUrl = `${ApiConstant.getSettableLoad}`; 
