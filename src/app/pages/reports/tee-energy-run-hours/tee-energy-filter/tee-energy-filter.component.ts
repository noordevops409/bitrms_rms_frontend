...
@Component({
  selector: 'app-tee-energy-filter',
  templateUrl: './tee-energy-filter.component.html',
  styleUrls: ['./tee-energy-filter.component.scss']
})
export class TeeEnergyFilterComponent implements OnInit {
