export const environment = {
  ...
  api: 'http://54.254.44.119:8080/digitrinity-rest-services/api',
  prodAPI: 'http://54.254.44.119:8080/digitrinity-rest-services_prod',
  mapbox: {
    accessToken: 'pk.eyJ1IjoiZGlnaXRyaW5pdHkiLCJhIjoiY2thMjdzaDY1MDNmZzNmbXN1Yjl4aXp5bSJ9.2rBqqFjtw-u4qtDSFkOR0w'
  }

  // api: 'http://54.254.44.119:8081/digitrinity/api'
